...
class LoginForm(forms.Form):
    username=forms.CharField(label=_('username'),max_length=30,widget=forms.TextInput(attrs={'size': 20,}))
    password=forms.CharField(label=_('password'),max_length=30,widget=forms.PasswordInput(attrs={'size': 20,}))
